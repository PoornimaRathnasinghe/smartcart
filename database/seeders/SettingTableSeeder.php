...
class SettingTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        Customer::Create([
            ...
            'email' => 'customer@reach-orbit.com',
            'phone' => '123456789',
            'country' => 'Sri Lanka',
            'city' => 'Colombo',
        ...
        Warehouse::create([
            ...
            'country' => 'Sri Lanka',
            'city' => 'Colombo',
            'email' => 'warehouse1@reach-orbit.com',
            'zip_code' => '12345',
        ]);

        Currency::create([
            'name' => 'Srilankan Rupees',
            'code' => 'LKR',
            'symbol' => 'Rs. ',
        ]);
        ...
        if (! keyExist('email')) {
            Setting::create(['key' => 'email', 'value' => 'support@reach-orbit.com']);
        }

        if (! keyExist('company_name')) {
            Setting::create(['key' => 'company_name', 'value' => 'StockPulse']);
        }
        ...
        if (! keyExist('developed')) {
            Setting::create(['key' => 'developed', 'value' => 'Orbit']);
        }

        if (! keyExist('footer')) {
            Setting::create([
                'key' => 'footer', 'value' => '2022 Developed by Orbit All rights reserved - v1.1.0',
            ]);
        }
        ...
        if (! keyExist('address')) {
            Setting::create([
                'key' => 'address', 'value' => 'C-303, Atlanta Shopping Mall, Majestic City, Colombo 05, Sri Lanka',
            ]);
        }
