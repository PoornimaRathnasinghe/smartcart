            ...
            >
                ...
                >
                    ...
                    <Card.Body className="px-2 pt-2 pb-1 custom-card-body">
                        <h6 className="product-title mb-0 text-gray-900 fs-2 ">
                            {product.attributes?.name}
                        </h6>
                        <span className=" fs-3  text-gray-700">
                            {product.attributes.code}
                        </span>
                        <p className="m-0 item-badges fs-4 ">
                            <Badge
                                bg="info"
                                text="white"
                                className="product-custom-card__card-badge fs-4 "
                            >
                        ...
                        <p className="m-0 item-badge fs-4 ">
                            <Badge
                                bg="primary"
                                text="white"
                                className="product-custom-card__card-badge fs-4 "
