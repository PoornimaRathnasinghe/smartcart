                        ...
                        <Table responsive>
                            ...
                            <tbody>
                                {updateProducts && updateProducts.map( ( singleProduct, index ) => {
                                    ...
                                    console.log( 'singleProduct', singleProduct.net_unit_cost )
                                    // console.log( 'singlePurchase.purchase_items', singlePurchase.purchase_items )
                                     const sub_total = ( singleProduct.quantity * singleProduct.net_unit_cost )
