                        ...
                        <div className='mt-5'>
                            ...
                            <Table responsive>
                                ...
                                {purchaseDetails.purchase_items && purchaseDetails.purchase_items.map((details, index) => {
                                    const purchaseItemCost = details.net_unit_cost * details.quantity;
                                    return (
                                        <tr key={index} className='align-middle'>
                                            ...
                                            <td>{currencySymbolHendling(allConfigData, frontSetting.value && frontSetting.value.currency_symbol, purchaseItemCost)}</td>
                                        </tr>)
                                })}
                                </tbody>
                            </Table>
