        ...
        <MasterLayout>
            ...
            <Row className='g-4'>
                <Widget title={getFormattedMessage( 'sales.title' )}
                    ...
                    value={warehouseReportData?.sale_count ? Number( warehouseReportData?.sale_count ) : '0'} />
                ...
                <Widget title={getFormattedMessage( 'purchases.title' )}
                    ...
                    value={warehouseReportData?.purchase_count ? Number( warehouseReportData?.purchase_count ) : '0'} />
                ...
                <Widget title={getFormattedMessage( 'dashboard.salesReturn.title' )}
                    ...
                    currency={''}
                    value={warehouseReportData?.sale_return_count ? Number( warehouseReportData?.sale_return_count ) : '0'} />
                ...
                <Widget title={getFormattedMessage( 'dashboard.purchaseReturn.title' )}
                    ...
                    currency={''}
                    value={warehouseReportData?.purchase_return_count ? Number( warehouseReportData?.purchase_return_count ) : '0'} />
            </Row>
