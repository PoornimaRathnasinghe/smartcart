        ...
        try {
            ...
            if ($purchaseStock) {
                ...
                if ($product->order_tax <= 100 && $product->order_tax >= 0) {
                    if ($purchaseStock['quantity'] > 0) {  // Check if quantity is greater than 0
                        ...
                        // Handle the case when quantity is 0
                        $purchaseStock['tax_amount'] = 0;
                        $perItemTaxAmount = 0;
                        // No need to adjust net_unit_cost for inclusive tax when quantity is 0
                    }
                } else {
